...
class InputPickerView<T:InputPickerData>: UIView,UIPickerViewDataSource,UIPickerViewDelegate {
    var pickerView = UIPickerView()
    typealias didSelectRow = (_ row:Int,_ str:String, _ model:T) -> ()
